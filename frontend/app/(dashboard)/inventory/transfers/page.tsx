  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link href="/inventory/transfers/new" className={cn(buttonVariants(), "bg-blue-600 hover:bg-blue-700")}>
              ...
              {items.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="text-right">
                    <Link href={`/inventory/transfers/${item.id}`} className={cn(buttonVariants({ variant: "ghost", size: "sm" }))}>
